...
RSpec.describe CommentariesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all commentaries as @commentaries" do
      ...
      expect(assigns(:commentaries)).to eq([commentary])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested commentary as @commentary" do
      ...
      expect(assigns(:commentary)).to eq(commentary)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new commentary as @commentary" do
      ...
      expect(assigns(:commentary)).to be_a_new(Commentary)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created commentary as @commentary" do
        post :create, {:commentary => valid_attributes}, valid_session
        expect(assigns(:commentary)).to be_a(Commentary)
        expect(assigns(:commentary)).to be_persisted
      end

      it "redirects to the created commentary" do
        post :create, {:commentary => valid_attributes}, valid_session
        expect(response).to redirect_to(Commentary.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved commentary as @commentary" do
        post :create, {:commentary => invalid_attributes}, valid_session
        expect(assigns(:commentary)).to be_a_new(Commentary)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested commentary" do
        commentary = Commentary.create! valid_attributes
        put :update, {:id => commentary.to_param, :commentary => new_attributes}, valid_session
        commentary.reload
      ...
      it "redirects to the commentary" do
        commentary = Commentary.create! valid_attributes
        put :update, {:id => commentary.to_param, :commentary => valid_attributes}, valid_session
        expect(response).to redirect_to(commentary)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the commentary as @commentary" do
        commentary = Commentary.create! valid_attributes
        put :update, {:id => commentary.to_param, :commentary => invalid_attributes}, valid_session
        expect(assigns(:commentary)).to eq(commentary)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the commentaries list" do
      commentary = Commentary.create! valid_attributes
      delete :destroy, {:id => commentary.to_param}, valid_session
      expect(response).to redirect_to(commentaries_url)
    end
  end
